...
public class HomeGUI extends JFrame {
	...
	public HomeGUI() {
		...
		jButtonLogin.setText(ResourceBundle.getBundle(ApplicationLauncher.ET).getString("HomeGUI.Login"));
		...
		jButtonRegister.setText(ResourceBundle.getBundle(ApplicationLauncher.ET).getString("HomeGUI.Register"));
		...
		jButtonNotRegister.setText(ResourceBundle.getBundle(ApplicationLauncher.ET).getString("HomeGUI.NotRegistered"));
		...
		jButtonAdmin.setText(ResourceBundle.getBundle(ApplicationLauncher.ET).getString("AdminGUI.Admin"));
		...
		setTitle(ResourceBundle.getBundle(ApplicationLauncher.ET).getString("MainGUI.MainTitle"));
