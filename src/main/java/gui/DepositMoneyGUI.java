...
public class DepositMoneyGUI extends JFrame{
	...
	public DepositMoneyGUI(Passenger p) {
		...
		setTitle(ResourceBundle.getBundle(ApplicationLauncher.ET).getString("DepositMoneyGUI.Wallet"));
		...
		JLabel lblNewLabelCantidad = new JLabel(ResourceBundle.getBundle(ApplicationLauncher.ET).getString("DepositMoneyGUI.Cuantity")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		btnNewButtonSartu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(facade.addMoney(passenger.getEmail(),am)) {
					textAreaResultado.setText(ResourceBundle.getBundle(ApplicationLauncher.ET).getString("DepositMoneyGUI.CI"));
				}else {
					textAreaResultado.setText(ResourceBundle.getBundle(ApplicationLauncher.ET).getString("DepositMoneyGUI.ERROR"));
				}
			}
		});
		...
		lblNewLabelActualMoney = new JLabel(ResourceBundle.getBundle(ApplicationLauncher.ET).getString("DepositMoneyGUI.Actual")); //$NON-NLS-1$ //$NON-NLS-2$
